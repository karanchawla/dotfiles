...
# View the current working status in short format
alias gs="git status"

# View the current working branch
alias gb="git branch"
...
# Pull in the remote changes for current repository and all its submodules
